...
const int 
    ...
    numero_escritores = 3;  // número de hebras escritoras
...
class Lec_Esc : public HoareMonitor
{
    ...
    unsigned num_escri,                     // contador de escritores
             num_lect_leyendo;
...
void Lec_Esc::ini_escritura()
{
    ...
    // con esto nos aseguramos que num_escri solo toma los valores 0 y 1.
    // Así, si está a 0, se registra 1. Cuando sale el escitor, comprueba
    // si el contador es mayor que 0. Si lo es, da paso a un escritor. Este
    // último, al iniciar la escritura, comprueba el contador y lo verá a 1,
    // disminuyéndolo a 0. De esta forma, al finalizar la escritura, da paso
    // a los lectores. Esta mecánica permite que pasen los escritores de dos en
    // dos y luego se le de prioridad a los lectores.
